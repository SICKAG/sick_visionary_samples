...
[source,bash]
----
python3 image_frontend_configuration/python/visionary_s_frontend_config.py -i192.168.1.10
----

**Visionary-T Mini frontend configuration**
[source,bash]
----
python3 image_frontend_configuration/python/visionary_t_mini_frontend_config.py -i192.168.1.10
----

**Save permanently**
[source,bash]
----
python3 image_frontend_configuration/python/save_permanently.py -i192.168.1.10 -dVisionary-S
----
