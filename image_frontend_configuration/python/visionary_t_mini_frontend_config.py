...
from python_base.Usertypes import BinningOption
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="This script demonstrates how to configure the frontend settings of a Visionary-T Mini device, such as binning option and frame period.")
