...
[source,bash]
----
python3 diagnosing_devices/python/system_log.py -i192.168.1.10 -dVisionary-S
----

**Diagnosing devices**
[source,bash]
----
python3 diagnosing_devices/python/device_state.py -i192.168.1.10 -dVisionary-S
----

**Diagnosing devices extended**
[source,bash]
----
python3 diagnosing_devices/python/device_state_extended.py -i192.168.1.10 -dVisionary-S
----
