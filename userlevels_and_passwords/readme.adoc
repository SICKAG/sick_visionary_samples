...
[source,bash]
----
python3 userlevels_and_passwords/python/login_logout.py -i192.168.1.10 -tVisionary-S
----

**Change password**
[source,bash]
----
python3 userlevels_and_passwords/python/password_change.py -i192.168.1.10 -tVisionary-S
----
